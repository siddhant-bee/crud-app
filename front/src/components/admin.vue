<template>
    ...
    <h2>Welcome To Admin View</h2>
     ...
     <div class="card-container">
       <div v-for="item in items"  >
         ...
         <button class="del" @click="deletee(item.task_id)" >DELETE TASK </button>
         <button class="del" @click="deletee(item.task_id);showmodal=true">UPDATE TASK</button>
 ...
 export default {
   ...
   created() {
     ...
     axios
       .get("http://localhost:5000/getadmintask")
       .then((response) => {
